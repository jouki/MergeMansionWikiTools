...
### LS_LuckySnap2024 — item discovered: LS_Common_CanadaGoose_01
`LS_Common_CanadaGoose_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['LS_Common_CanadaGoose_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: 7085190
`LS_Common_HerringGull_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['7085190'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Common_HerringGull_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: 67508326
`LS_Epic_LongEaredOwl_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['67508326'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Epic_LongEaredOwl_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: LS_Epic_MandarinDuck_01
`LS_Epic_MandarinDuck_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['LS_Epic_MandarinDuck_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: 44053658
`LS_Legendary_Kingfisher_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['44053658'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Legendary_Kingfisher_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: LS_Legendary_RedcrownedCrane_01
`LS_Legendary_RedcrownedCrane_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['LS_Legendary_RedcrownedCrane_01'], moment=item discovered (versions 26.03.01–26.07.01)
...
### LS_LuckySnap2024 — item discovered: 62814398
`LS_Rare_CommonLoon_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['62814398'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Rare_CommonLoon_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: 54640858
`LS_Rare_PileatedWoodpecker_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['54640858'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Rare_PileatedWoodpecker_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: LS_Rare_WillowPtarmigan_01
`LS_Rare_WillowPtarmigan_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['LS_Rare_WillowPtarmigan_01'], moment=item discovered (versions 26.03.01–26.07.01)
...
### LS_LuckySnap2024 — item discovered: 60448975
`LS_Ultimate_CrescentCapedLophora_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['60448975'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Ultimate_CrescentCapedLophora_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: 60317856
`LS_Ultimate_Peacock_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['60317856'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Ultimate_Peacock_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: LS_Ultimate_Shoebill_01
`LS_Ultimate_Shoebill_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['LS_Ultimate_Shoebill_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: 55205260
`LS_Uncommon_BlueJay_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['55205260'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Uncommon_BlueJay_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: LS_Uncommon_Dunlin_01
`LS_Uncommon_Dunlin_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['LS_Uncommon_Dunlin_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: 38373303
`LS_Uncommon_Robin_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['38373303'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_Uncommon_Robin_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: LS_VeryRare_BurrowingOwl_01
`LS_VeryRare_BurrowingOwl_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['LS_VeryRare_BurrowingOwl_01'], moment=item discovered (versions 26.03.01–26.07.01)

_Referenced by the game, but no lines matched this id._

### LS_LuckySnap2024 — item discovered: 26206303
`LS_VeryRare_PeregrineFalcon_01_Dialogue`
- trigger: item, event=LS_LuckySnap2024, items=['26206303'], moment=item discovered (versions 25.05.01–25.06.01)
- trigger: item, event=LS_LuckySnap2024, items=['LS_VeryRare_PeregrineFalcon_01'], moment=item discovered (versions 26.03.01–26.07.01)
