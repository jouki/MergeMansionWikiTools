...
### Grandma's Pool Party — item discovered: Analogue Cassettes
`LDE_GrandmasBirthday2023_AnalogueTapesChain_Dialogue` · seen 23.09.02–26.07.01
- trigger: item, event=Grandma's Pool Party, eventKey=LDE_GrandmasBirthday2023, itemKeys=['LDE_GrandmasBirthday2023_PodcastCassette_01'], items=['Analogue Cassettes'], moment=item discovered (versions 23.09.02–26.07.01)

**MADDIE**: Done! First podcast episode in the can!
**MADDIE**: While modern podcasting is purely digital, I guess it doesn’t hurt to go old school...
**MADDIE**: Besides, analogue sounds better! I'm sure this podcast will be a hit!

### Grandma's Pool Party — entering board
`LDE_GrandmasBirthday2023_BoardIntro_Dialogue` · seen 24.04.01–26.07.01
- trigger: event, event=Grandma's Pool Party, eventId=LDE_GrandmasBirthday2023, eventType=Collectible Board Event, moment=entering board (versions 24.04.01–26.07.01)

**MADDIE**: I gotta make sure to get something nice for Grandma this year.
**MADDIE** (Doubtful): She doesn’t really enjoy celebrating her birthday for some reason...
**MADDIE** (Joyous): But that doesn’t mean she shouldn’t deserve one!
