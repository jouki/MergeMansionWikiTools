...
### Gallery: Remove the sheet
`CameraTalk` · seen 24.04.01–26.07.01
- trigger: area, area=Gallery, areaId=Gallery, hotspotId=GalleryRemoveGalleryCameraDustSheetBb3, phase=task completed, task=Remove the sheet (versions 24.04.01–26.07.01)

**MADDIE** (Joyous): A vintage camera! I've always wanted to try one of these...
**MADDIE** (Encouraging): This has to be the camera Lindsay used on her adventures!

### Gallery: Place the fossil
`FossilTalk` · seen 24.04.01–26.07.01
- trigger: area, area=Gallery, areaId=Gallery, hotspotId=GallerySwapGalleryFossilRundownCa3, phase=task completed, task=Place the fossil (versions 24.04.01–26.07.01)

**MADDIE**: Ooh, these tracks are interesting!
**MADDIE**: Says here on the plaque that these belonged to a predator hunting its pray.
**MADDIE** (Surprised): Eeeh, wouldn't want one these things chasing me!
...
**MADDIE** (Relaxed): Good ol' Ignatius Boulton, out adventuring and...
**MADDIE** (Surprised): Wait a minute... Is that a live dodo?!

### Gallery: Fix the parquet
`MapDiscovery` · seen 24.04.01–26.07.01
- trigger: area, area=Gallery, areaId=Gallery, hotspotId=GalleryRemoveParquetFloorDamageA2, phase=task completed, task=Fix the parquet (versions 24.04.01–26.07.01)

**MADDIE** (Thinking): Hey, what's this? There's an old map buried under all the debris here.
**MADDIE** (Joyous): Ooh, it looks like Lindsay's adventure map!
**MADDIE** (Joyous): How fun would it be to retrace her steps. It would surely help me understand this gallery better!
**MADDIE** (Encouraging): Let's go on an adventure!
...
### Gallery: Clean the chair
`Suitcase` · seen 24.04.01–26.07.01
- trigger: area, area=Gallery, areaId=Gallery, hotspotId=GalleryRemoveGalleryFootStoolRunDownA4, phase=task completed, task=Clean the chair (versions 24.04.01–26.07.01)

**MADDIE** (Thinking): Hmm, this suitcase looks quite out of place here.
**MADDIE** (Thinking): I wonder whose it is and whether I can open it...
**MADDIE** (Doubtful): Oh no, it needs a code!
**MADDIE** (Doubtful): I'll have to come back to this some other time...

### Gallery: Polish the statue
`TigerTalk` · seen 24.04.01–26.07.01
- trigger: area, area=Gallery, areaId=Gallery, hotspotId=GalleryPlacePolishedTigerEa6, phase=task completed, task=Polish the statue (versions 24.04.01–26.07.01)

**MADDIE** (Surprised): That's a big kitty.
**MADDIE** (Doubtful): It reads here that this statue is dedicated to "Our friend..." 
**MADDIE** (Thinking): Hmmm... I wonder who that was?

### Gallery: Place the toucan
`ToucanTalk` · seen 24.04.01–26.07.01
- trigger: area, area=Gallery, areaId=Gallery, hotspotId=GalleryPlaceGalleryToucanTaxidermyBc2, phase=task completed, task=Place the toucan (versions 24.04.01–26.07.01)

**MADDIE**: The toucan! One of my favorite birds.
**MADDIE** (Relaxed): I've always wished to see them in their natural habitat...
**MADDIE** (Thinking): Hmm... Maybe after all this, I'll head south and do just that!
