...
**MADDIE** (Discouraged): *Sigh* Why did Arthur have to come back, NOW?!
**MADDIE** (Doubtful): And I’ve never seen Roddy like that before!
...
**MADDIE** (Thinking): These stones look familiar...
**MADDIE**: I'm pretty sure I've seen them around...  
  _earlier:_ ~~I think I saw them in the secret society chamber as well!~~ (until 26.02.03)
**MADDIE**: I wonder what their meaning is?
**MADDIE**: Could it be connected to this secret group? Perhaps their symbol?  
  _earlier:_ ~~Perhaps their symbol?~~ (until 26.02.03)

### Cinema: Place popcorn box
`CinemaPOIChairs` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaPlacePopcornBoxTrayE11, phase=task completed, task=Place popcorn box (versions 25.02.01–26.07.01)

**MADDIE** (Doubtful): These chairs look... Different.
**MADDIE**: Almost regal and not really something you’d see in a cinema.
**MADDIE** (Encouraging): They're not in great shape though. I should probably switch these out to something more cozy.

### Cinema: Find control panel
`CinemaPOIControlPanel` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaAnimateScreenDownCb5, phase=task completed, task=Find control panel (versions 25.02.01–26.07.01)

**MADDIE** (Surprised): Whoa! That control panel was for this screen!
**MADDIE** (Thinking): How cool! And... strangely modern for this place...
**MADDIE** (Charming): But thanks to whoever set this up, I can actually have a movie night here someday!

### Cinema: Clear film rolls
`CinemaPOIFilmReels` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaRemoveFilmCa7, phase=task completed, task=Clear film rolls (versions 25.02.01–26.07.01)
...
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaSwapStatueHeadD7, phase=task completed, task=Attach head (versions 25.02.01–26.07.01)

**MADDIE** (Joyous): Ah! This character is familiar...
**MADDIE** (Encouraging): I loved these movies, and they made me want to become an archaeologist as a kid!
**MADDIE** (Thinking): I should watch them again...

### Cinema: Remove film reel
`CinemaPOIJournalPage` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaRemoveFilmPileJ2, phase=task completed, task=Remove film reel (versions 25.02.01–26.07.01)

**MADDIE** (Doubtful): Hmm... I still can't figure out the encryption in this journal! If only there were instructions an-
**MADDIE** (Surprised): Wait a minute! The mutoscope! The instructional video seemed to focus on symbols!
**MADDIE** (Joyous): Yes! They match the ones in the journal! I think they're the key! Let's use them!
**MADDIE** (Thinking): Hmm... It first mentions to "Go up to discover the secret." and then "Go down to uncover the truth!"
**MADDIE** (Doubtful): What does that mean? Is there a hidden passage that leads to an upstairs area?

### Cinema: Cut leaves
`CinemaPOIMasks` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaRemoveIvyStageC2, phase=task completed, task=Cut leaves (versions 25.02.01–26.07.01)

**MADDIE**: Ah... Comedy and Tragedy. The foundations of theater.
**MADDIE** (Discouraged): And ironically, my life...

### Cinema: Fix lights
`CinemaPOIMutoscope` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaPlaceLightMutuscopeB7, phase=task completed, task=Fix lights (versions 25.02.01–26.07.01)

**MADDIE** (Surprised): Wow! I know what this is...
**MADDIE** (Surprised): It’s a mutoscope! Coin-operated too!
**MADDIE** (Encouraging): Instead of film, it would use a series of images, much like a flip book.
**MADDIE** (Thinking): Hmm... What an odd movie! Looks like an instructional video for spies...

### Cinema: Replace parts
`CinemaPOIPopcorn` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaAnimatePopcornMachineState02F2A1, phase=task completed, task=Replace parts (versions 25.02.01–26.07.01)

**MADDIE** (Relaxed): Nothing like the smell of fresh popcorn in the cinema!
**MADDIE** (Encouraging): Just something so magical and special about it that it makes you forget how easily it gets stuck in your teeth.
**MADDIE** (Relaxed): Worth it though.

### Cinema: Remove spiderweb
`CinemaPOIProjector` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaRemoveWebsProjectorEc1, phase=task completed, task=Remove spiderweb (versions 25.02.01–26.07.01)

**MADDIE** (Thinking): This film projector is old but...
**MADDIE** (Doubtful): It seems to have some unique features to it. Almost like it got an upgrade...
**MADDIE** (Thinking): I wonder if Eddie the musician had something to do with this.
**MADDIE** (Thinking): I really have to host a movie night here, some day.

### Cinema: Search seats
`CinemaPOISpyDocuments` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaRemoveSecretNoteEd6, phase=task completed, task=Search seats (versions 25.02.01–26.07.01)

**MADDIE** (Surprised): Heyy... What’s this? Documents between the seats?
**MADDIE** (Doubtful): These look old... But important. Assuming that the label “Top Secret” in big red letters is to be believed.
**MADDIE** (Surprised): Don't think it'll hurt to open it up... Oh wow! It looks like it's from some kind of secret organization.  
...
`CinemaPOIStage` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaRemoveFilmTinsRundownCa4, phase=task completed, task=Clear film cans (versions 25.02.01–26.07.01)

**MADDIE** (Encouraging): There's an inscription on the stage floor - “All the world’s a stage...”
**MADDIE** (Thinking): Hmm... I wonder if they ever performed Shakespeare here.
**MADDIE** (Thinking): There seems to be some kind of control panel here as well. Maybe it's for stage lights...

### Cinema: Place new chair
`CinemaPOISymbolChart` · seen 25.02.01–26.07.01
- trigger: area, area=Cinema, areaId=Cinema, hotspotId=CinemaPlaceChairRightBackEd9, phase=task completed, task=Place new chair (versions 25.02.01–26.07.01)

**MADDIE** (Surprised): Wait, a minute... These symbols look familiar!
**MADDIE** (Thinking): They’re the same as the ones behind the old seats! But... that’s not all!
**MADDIE** (Surprised): Those confidential documents I found under the seats make sense now!
**MADDIE** (Surprised): This chart helped identify where each important individual sat. Seems quite crucial!
**MADDIE** (Thinking): This place definitely has a spy connection - just like the Library!
