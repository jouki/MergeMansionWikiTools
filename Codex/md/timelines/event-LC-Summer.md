# Summer Lucky Catch — dialogue timeline (event)
`event:LC_Summer` · versions 24.04.01–26.07.01 (32)

## Order in 26.07.01
- **  2 %** · intro · `LC_Summer_2026_Intro_Dialogue` — entering the board
    - Emilio: Hello, Mrs. Boulton!
    - Grandma: Emilio? What are you doing here?
- ** 95 %** · outro · `LC_Summer_MolaMola_Dialogue` — chain 'Mola Mola' 15/15, level 1/1 — inferred from the story id (estimate)
- **100 %** · outro · `LC_Summer_2026_Outro_Dialogue` — event end
