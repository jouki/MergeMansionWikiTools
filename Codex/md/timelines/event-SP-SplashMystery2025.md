# Splash of Mystery — dialogue timeline (event)
`event:SP_SplashMystery2025` · versions 25.04.02–26.07.01 (23)

## Order in 26.07.01
- **  0 %** · intro · `SP_SplashMystery2025_Intro_Dialogue` — event intro
    - Mason: Do you know what day is almost here?
    - Emilio: Hmm... Tuesday?
- ** 18 %** · early · `SP_SplashMystery2025_LastCollectibleItemDiscovered_Dialogue` — item 'Kick Board': chain 'Pool Party Essentials' 1/7, item level 4/4 (estimate)
    - Maddie: What have you got planned for Mason's big party?
    - Pearl: Pfft, you know what he's like.
- **100 %** · outro · `SP_SplashMystery2025_AllRewardsCompleted_Dialogue` — event end
