...
{
    public const string Version = "v0.24.105";
...
public class AppSettings
{
    ...
    // AB experiment bucket — when set, MysteriesPage loads <DumpFolder>/<bucketName>/events.json
    // instead of the base events.json. Empty/null = use base. Used to view patched mystery rewards
    // (e.g. Rebalance_SeasonPass_May2026_01_B which swaps Apiary L02 Hourglass → CooldownRemover).
    public string ActiveSeasonPassBucket { get; set; } = "";
