...
{
    public class MergeChainDumper : JsonDumper<IList<MergeChainDefinition>>
    {
        ...
        {
            if (config.MergeChains == null)
                throw new System.InvalidOperationException("MergeChains is null — import may have failed for this entry. Check import log for errors.");
